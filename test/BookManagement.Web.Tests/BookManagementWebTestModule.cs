...
using BookManagement.Web.Menus;
...
[DependsOn(
    ...
    typeof(BookManagementApplicationTestModule),
    typeof(BookManagementEntityFrameworkCoreTestModule)
)]
public class BookManagementWebTestModule : AbpModule
{
    public override void PreConfigureServices(ServiceConfigurationContext context)
    {
        context.Services.PreConfigure<IMvcBuilder>(builder =>
        {
            builder.PartManager.ApplicationParts.Add(new CompiledRazorAssemblyPart(typeof(BookManagementWebModule).Assembly));
        });
